...
STOCKS = [
    ...
    "BHARTIARTL", "LT", "KOTAKBANK", "AXISBANK", "HINDUNILVR", "MARUTI",
    "SUNPHARMA", "TITAN", "ULTRACEMCO", "ASIANPAINT", "BAJFINANCE",
    "NTPC", "POWERGRID", "TATASTEEL", "TATAMOTORS", "WIPRO", "ONGC",
    "ADANIENT", "ADANIPORTS", "COALINDIA", "HCLTECH", "M&M", "NESTLEIND",
    "HYUNDAI", "DIXON", "MANAPPURAM", "SHRIRAMFIN", "GVT&D", "SONACOMS", "MCX", 
    "DELHIVERY", "ZYDUSLIFE", "DIVISLAB", "ABCAPITAL", "PIDILITIND", "FORTIS", 
    "PFC", "MFSL", "HDFCAMC", "LTF", "TIINDIA", "KALYANKJIL", "ALKEM", 
    "HINDZINC", "NBCC", "HEROMOTOCO", "MUTHOOTFIN", "PIIND", "SBICARD", "ABB", 
    "JUBLFOOD", "UNOMINDA", "ICICIGI", "FORCEMOT", "UPL", "POWERINDIA", "RADICO", 
    "CIPLA", "IOC", "ADANIPOWER", "CANBK", "MOTHERSON", "BANKINDIA", "HDFCLIFE", 
    "SIEMENS", "AMBER", "DALBHARAT", "ADANIENSOL", "BANKBARODA", "KAYNES", 
    "ICICIPRULI", "APOLLOHOSP", "JINDALSTEL", "BRITANNIA", "ASHOKLEY", "JIOFIN", 
    "POLICYBZR", "UNITDSPR", "ANGELONE", "IDEA", "CGPOWER", "360ONE", 
    "NATIONALUM", "TMPV", "COCHINSHIP", "LICI", "PNB", "GLENMARK", "ASTRAL", 
    "CHOLAFIN", "AUBANK", "LICHSGFIN", "LUPIN", "RECLTD", "BANDHANBNK", 
    "INOXWIND", "BLUESTARCO", "CUMMINSIND", "PGEL", "IEX", "MOTILALOFS", 
    "PREMIERENE", "SAIL", "YESBANK", "BAJAJ-AUTO", "INDIGO", "LAURUSLABS", 
    "BHEL", "PRESTIGE", "UNIONBANK", "BAJAJFINSV", "FEDERALBNK", "APLAPOLLO", 
    "COLPAL", "PAYTM", "NYKAA", "DRREDDY", "GRASIM", "HINDPETRO", "MAZDOCK", 
    "PNBHOUSING", "VOLTAS", "BPCL", "MARICO", "OBEROIRLTY", "TRENT", "VBL", 
    "BHARATFORG", "INDIANB", "KFINTECH", "BSE", "IDFCFIRSTB", "PAGEIND", 
    "WAAREEENER", "BIOCON", "JSWSTEEL", "SBILIFE", "GMRAIRPORT", "INDUSINDBK", 
    "VEDL", "CDSL", "HAVELLS", "IRFC", "SWIGGY", "VMM", "DMART", "EICHERMOT", 
    "NAM-INDIA", "NUVAMA", "SUPREMEIND", "AUROPHARMA", "GODREJPROP", 
    "INDUSTOWER", "PHOENIXLTD", "AMBUJACEM", "HAL", "OFSS", "TORNTPHARM", 
    "BOSCHLTD", "SHREECEM", "DLF", "RBLBANK", "ADANIGREEN", "BAJFINANCE", 
    "CROMPTON", "GODFRYPHLP", "GODREJCP", "MANKIND", "MAXHEALTH", "NMDC", 
    "PETRONET", "RVNL", "SOLARINDS", "SUZLON", "TATAPOWER", "KEI", "PATANJALI", 
    "OIL", "TVSMOTOR", "CONCOR", "NHPC", "JSWENERGY", "NAUKRI", "BAJAJHLDNG", 
    "IREDA", "BDL", "DABUR", "EXIDEIND", "CAMS", "POLYCAB", "TATACONSUM", 
    "LODHA", "HINDALCO", "SRF", "BEL", "INDHOTEL", "ETERNAL", "GAIL", 
    "KPITTECH", "LTM", "COFORGE", "MPHASIS", "PERSISTENT", "TECHM", "TATAELXSI"
]
